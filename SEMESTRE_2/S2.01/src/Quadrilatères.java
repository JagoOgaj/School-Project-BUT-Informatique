...
public class Quadrilatères extends Forme {
	...
	public Quadrilatères (String name, PointPlan p1, PointPlan p2, PointPlan p3, PointPlan p4) {
		...
		if (!(p1 instanceof PointPlan) || !(p2 instanceof PointPlan) || !(p3 instanceof PointPlan) || !(p4 instanceof PointPlan)) {
	...
	public void deplacer(int x, int y) {
		...
		if (Integer.valueOf(x).getClass().getName().equals(Integer.class.getName()) &&
			    ...
			    p4.setAbscisse(p4.getAbscisse()+x);
			    p4.setOrdonnee(p4.getOrdonnee()+y);
			} else {
